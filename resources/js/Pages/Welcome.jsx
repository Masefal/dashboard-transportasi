...
const dataProporsi = [
    { name: 'Kendaraan Pribadi', value: 55 },
    { name: 'Ojek Online', value: 25 },
    { name: 'Kendaraan Umum', value: 15 },
    { name: 'Kendaraan Barang', value: 5 },
];

const COLORS = ['#4a85ce', '#2d4975', '#60a5fa', '#93c5fd'];

export default function Welcome() {
    const [activeCity, setActiveCity] = useState(MASTER_DATA_KOTA[0]);
                    ...
                    <div className="p-6 space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                            ...
                            <div className="col-span-1 bg-[#1f232b] border border-slate-700/50 rounded-lg flex flex-col h-[400px]">
                                ...
                                <div className="p-4 overflow-y-auto text-sm space-y-3 flex-1 text-slate-300">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="bg-[#1f232b] border border-slate-700/50 rounded-lg p-5 h-72">
                                ...
                                <ResponsiveContainer width="100%" height="85%">
                                    <BarChart data={dataUMR} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                            ...
                            <div className="bg-[#1f232b] border border-slate-700/50 rounded-lg p-5 h-72">
                                <h3 className="text-sm font-medium mb-4">Diagram Lingkaran Proporsi Kendaraan</h3>
                                <ResponsiveContainer width="100%" height="85%">
                                    <PieChart>
                                        <Pie
                                            data={dataProporsi}
